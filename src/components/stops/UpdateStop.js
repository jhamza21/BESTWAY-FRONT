...
import { FormGroup, TextField, Button, CircularProgress, Divider, Slider, Typography, FormControl, InputAdornment, InputLabel, OutlinedInput } from '@material-ui/core';
import useStyles from "../shared/material-ui-css"
import { useDispatch, useSelector } from "react-redux"
import { updateStop } from "../../redux/stops/stopAction";
import history from "../../services/history";
import Map from "../map/Map"

export default function UpdateStop(props) {
  ...
  const submit = async (e) => {
    e.preventDefault();
    dispatch(updateStop(data._id, data))
  };
